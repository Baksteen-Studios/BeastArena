...
void GadgetSpawnSystem::update(double deltatime){
    ...
    //         if(gadget.compare("Pistol")) {
    //             entity_factory->createPistol(spawn->x, spawn->y, true, entity_id);
    //         } else if(gadget.compare("Rifle")) {
    //             entity_factory->createRifle(spawn->x, spawn->y, true, entity_id);
    //         } else if(gadget.compare("Sniper")) {
    //             entity_factory->createSniper(spawn->x, spawn->y, true, entity_id);
    //         }
