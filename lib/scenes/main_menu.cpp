...
void MainMenu::performPrepare() {
    ...
    }
    {
        ...
        auto comps_list = factory.createButton("Debug level", { 255, 255, 255, 255}, 70, "menu/button.png", 960, 640, 400, 100, 255, getRelativeModifier(), on_click);
        for(auto& comps : comps_list) {
            entity_components->push_back(std::move(comps));
        }
    }
    {
        ...
        auto comps_list = factory.createButton("Help", { 255, 255, 255, 255}, 70, "menu/button.png", 960, 760, 400, 100, 255, getRelativeModifier(), on_click);
        for(auto& comps : comps_list) {
            entity_components->push_back(std::move(comps));
        }
    }
    {
        ...
        auto comps_list = factory.createButton("Credits", { 255, 255, 255, 255}, 70, "menu/button.png", 960, 880, 400, 100, 255, getRelativeModifier(), on_click);
        for(auto& comps : comps_list) {
            entity_components->push_back(std::move(comps));
        }
    }
    {
        ...
        auto comps_list = factory.createButton("Exit game", { 255, 255, 255, 255}, 70, "menu/button.png", 960, 1000, 400, 100, 255, getRelativeModifier(), on_click);
        for(auto& comps : comps_list) {
            entity_components->push_back(std::move(comps));
        }
    }
